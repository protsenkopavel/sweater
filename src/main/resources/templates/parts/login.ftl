...
<form action="${path}" method="post" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html"
    ...
    <#if isRegisterForm>
     <div class="form-group row">
        ...
        <div col-sm-6>
        <div class="g-recaptcha" data-sitekey="6LeEMzwpAAAAAByD92ZMcnZGpK_OdWr5t3fRPNnA"></div>
        <#if captchaError??>
        ...
        <button class="btn btn-primary" type="submit"/><#if isRegisterFrom>Create<#else><Sign In</#if></button>
    </form>
</#macro>
